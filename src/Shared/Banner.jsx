...
const Banner = () => {
  ...
  return (
    <div className="relative bg-[url(/assets/Banner2.jpg)] bg-no-repeat bg-cover w-full bg-center mt-[60px]  ">
      <div className="max-w-[1500px] mx-auto px-4 flex items-center flex-col md:flex-row justify-center md:justify-between  gap-10  md:pt-0 pb-20 md:pb-0">
        {/* <div className="absolute top-0 right-0 left-0 bg-black opacity-40 z-1"></div> */}
        <div className="z-9">
          <Section1>
            <div className="text-[#ffa600] mx-4">
              <p className="text-2xl md:text-4xl lg:text-5xl font-bold text-center md:text-left mt-20 md:mt-0">
