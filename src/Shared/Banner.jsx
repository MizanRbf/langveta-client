...
const Banner = () => {
  ...
  return (
    <div className="md:h-screen relative bg-[url(/assets/Banner.jpg)] bg-no-repeat bg-cover bg-center flex items-center flex-col md:flex-row justify-center md:justify-between  gap-10 pt-30 md:pt-0 pb-20 md:pb-0 mt-[84px]">
